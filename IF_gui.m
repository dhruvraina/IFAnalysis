...
if get(handles.chk_AxisThresh, 'Value')
    handles.calcs.XAxisThresh = str2double(get(handles.etx_SetXThresh, 'String'));
    handles.calcs.YAxisThresh = str2double(get(handles.etx_SetYThresh, 'String'));
    handles.calcs.Ratios = 1;
else
    handles.calcs.XAxisThresh = 0;
    handles.calcs.YAxisThresh = 0;
    handles.calcs.Ratios      = 0;
end
